						...
						<div class="col-md-8 col-sm-12">
							<article class="post_item_excerpt">
								<div class="post_content">
									...
									<form class="myForm1" method="get" action="" id='backgroundColor'>
									<p class='leftPadding topPadding'>Main Contact Information</p>
										...
										<p>
											<label id='label1'>Identification Type
												<input type="text" name="identificationType" placeholder='Identification Type' required>
											</label>
										</p>
										<p>
											<label id='label1'>Identification Number
												<input type="text" name="identificationNumber" placeholder='Identification Number' required>
											</label>
										</p>
										<p>
											<label id='label1'>Primary Contact Number
											  <input type="text" name="securityCode"  placeholder='Contact Number' required>
											</label>
										</p>
										<p>
										...
										<p>
											<label id='label1'>Autorized Users
											  <input type="text" name="securityCode"  placeholder='Name' required>
											</label>
										</p>
									...
									<fieldset>
										<p><label id='label1'> <input type="checkbox" name="delivery" required value="delivery">I have opt in to have all of my packages deliver to the address listed above</label></p>
										<p><label id='label1'> <input type="checkbox" name="pickup" required value="pickup">I will pick up all my packages at the RPM main office in </label></p>
									</fieldset>
									...
									<div class="sc_accordion sc_accordion_style_1" data-active="0" role="tablist">
											<div class="sc_accordion_item sc_active">
												<h5 class="sc_accordion_title" role="tab" id="ui-id-1" aria-controls="ui-id-2">
													<span class="sc_accordion_icon sc_accordion_icon_closed icon-down-open"></span>
													<span class="sc_accordion_icon sc_accordion_icon_opened icon-down-open"></span>
													Autorized Users
												</h5>
												<div class="sc_accordion_content" id="ui-id-2" aria-labelledby="ui-id-1" role="tabpanel">
													<div>
														<table class='mine'>
														  <tr>
														  ...
														  <tr>
															<td class='mine'>userName</td>
															<td class='mine'>$userNumber</td>
															<td class='mine'>$userId</td>
														  </tr>
														</table>
													</div>
												</div>
								...
								<aside class="widget widget_recent_entries myPadding" id='myTrYellow'>
									...
									<p>Fees are being calculated on the CIF value of your purchase (Cost + Insurance + Freight)</p>
										<div class="fields">
											<div class="fields">
												<div class="dfield">
													<input name="destination" id='almostCompleteWidth' type="text" value="" placeholder="Destination">
												</div>
											</div>
											<div class="fields">
												<div class="dfield">
													<input name="category" id='almostCompleteWidth'  type="text" value="" placeholder="Item Category">
												</div>
											</div>
											<div class="fields">
												<div class="dfield">
													<input name="total" id='almostCompleteWidth'  type="text" value="" placeholder="Total Value $ USD">
												</div>
											</div>
											<div class="fields">
												<div class="dfield">
													<input name="weight" id='almostCompleteWidth'  type="text" value="" placeholder="Weight (Lbs) ">
												</div>
											</div>
										</div>
										...
										<div class="fields">
											<div class="fields radio_label_top">
												<fieldset>
													<p><label id='label1'> <input type="checkbox" name="freight" required value="freight"> Freight </label> $10.02</p>
													<p><label id='label1'> <input type="checkbox" name="insurance" required value="insurance"> Insurance </label>$2.00</p>
													<p><label id='label1'> <input type="checkbox" name="duty" required value="duty"> Duty </label>$21.00</p>
													<p><label id='label1'> <input type="checkbox" name="vat" required value="vat"> VAT </label>$17.32</p>
												</fieldset>
											</div>
										</div>
										<div class="fields ">
											<div class="fields result">
												...
												<div class="dfield">
													<input name="usd" class="codepeoplecalculatedfield field large" id='almostCompleteWidth' type="text" value="$ USD">
													<input name="ttd" class="codepeoplecalculatedfield field large" id='almostCompleteWidth' type="text" value="$ TTD">
												</div>
											</div>
										</div>
									</div>
